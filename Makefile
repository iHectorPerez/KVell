...
LDLIBS=-lm -lpthread -lstdc++ -lKVell_NVM_Indexes -ltbb

INDEXES_OBJ=indexes/rbtree.o indexes/rax.o indexes/art.o indexes/btree.o indexes/fptree.o
MAIN_OBJ=main.o slab.o freelist.o ioengine.o pagecache.o stats.o random.o slabworker.o workload-common.o workload-ycsb.o workload-production.o utils.o in-memory-index-rbtree.o in-memory-index-rax.o in-memory-index-art.o in-memory-index-btree.o in-memory-pmem-index-fptree.o ${INDEXES_OBJ}
